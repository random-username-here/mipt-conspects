...
На это есть теорема на лекциях. Есть одно исключение -- если в линеаризации
получили центр, то есть шанс, что это на самом деле медленно сходящийся/расходящийся фокус.

Поэтому в случае центра нужно переходить в полярные координаты и проверять $r'$.

Также важно понимать, что все эти нарисованные линии для линеаризации -- приближение того, что происходит вокруг точки.
